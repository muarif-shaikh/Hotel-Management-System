...
def printReceipt():
    try:
        ...
        my_Style = ParagraphStyle('My Para style', fontName="Times-Roman", fontSize=16, alignment=0, borderWidth=2,borderColor='black', backColor = '#E6FFE6', borderPadding = (20, 20, 20), leading = 20)
        width, height = A4
...
def appLogin():
    ...
    lbtn = tk.Button(root, text="LOGIN", font=("dubai", 15), bg="#00cc99", fg="white", relief="solid",
                     bd=1,command=loginF)
